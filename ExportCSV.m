function ExportCSV(src,event)
    global REC_HANDLES IM IM_METADATA FLOUR_MEAN_PER_T
    ...
    fprintf(fHandle,'Time (s), FRAP (original), FRAP (correct)\n');
    for t=1:IM_METADATA.NumberOfFrames
        fprintf(fHandle,'%f,%f,%f\n',IM_METADATA.TimeStampDelta(t),frapMean(t),frapCorrected(t));
    end
